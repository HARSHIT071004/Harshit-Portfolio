...
//       <h2 className="text-6xl sm:text-4xl font-bold text-[#b76dfc] mb-6 sm:mb-4">
//         About Me
//       </h2>
//       <p className="text-2xl sm:text-lg text-white leading-relaxed">
...
//       </p>
//       <button className="border border-orange rounded-full py-2 px-4 text-lg flex gap-2 items-center mt-8 sm:mt-6 hover:bg-orange transition-all duration-500 cursor-pointer md:self-start sm:self-center">
//         <Link
//           spy={true}
//           smooth={true}
//           duration={500}
...
// const AboutMeText = () => {
//   return (
//     <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center sm:px-4 sm:block">
//       <h2 className="text-6xl sm:text-4xl font-bold text-[#b76dfc] mb-6 sm:mb-4">
//         About Me
//       </h2>
...
//         curiosity and the desire to create real-world solutions that make an impact.
//       </p>
//       <button className="border border-orange rounded-full py-2 px-4 text-lg flex gap-2 items-center mt-8 sm:mt-6 hover:bg-orange transition-all duration-500 cursor-pointer md:self-start sm:self-center sm:w-full">
//         <Link
//           spy={true}
//           smooth={true}
//           duration={500}
