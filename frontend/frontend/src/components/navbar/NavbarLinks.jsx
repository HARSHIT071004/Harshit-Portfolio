...
const NavbarLinks = () => {
  return (
    <ul className="flex lg:flex-row sm:flex-col gap-6 font-body lg:relative sm:absolute sm:top-[120%] text-center left-[50%] -translate-x-[50%] lg:text-md sm:text-lg sm:bg-cyan/30 sm:backdrop-blur-md lg:bg-transparent sm:w-full py-4 sm:p-3 sm:rounded-lg sm:shadow-md">
      {links.map((link, index) => {
        return (
